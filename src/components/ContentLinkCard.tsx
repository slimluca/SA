...
export function ContentLinkCard({ title, description, href }: ContentLinkCardProps) {
  return (
    <Link
      href={href}
      className="group flex h-full min-h-[190px] flex-col rounded-2xl border border-oat bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-soft"
    >
      <div className="mb-4 flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-honey/20 text-cocoa">
