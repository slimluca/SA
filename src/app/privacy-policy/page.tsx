      ...
      <div className="mt-8 space-y-5 rounded-2xl border border-oat bg-white p-6 shadow-sm">
        <section>
          ...
          <p className="mt-2 leading-7 text-bark">
            If you email DogHaven, your email address and message may be used to respond, review a
            correction, or consider a guide topic. Do not send sensitive medical records unless a
            qualified veterinary professional has told you it is appropriate.
          </p>
        </section>
        <section>
